...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkQuery = "SELECT * FROM Excursion_Input WHERE user_id  = ?";
    ...
    if ($checkResult->num_rows > 0) {
        ...
        $updateQuery = "UPDATE Excursion_Input SET 1wahl=?, 2wahl=?, 3wahl=?, 4wahl=?, 5wahl=? WHERE user_id =?";
        ...
        $insertQuery = "INSERT INTO Excursion_Input (user_id , 1wahl, 2wahl, 3wahl, 4wahl, 5wahl) VALUES (?, ?, ?, ?, ?, ?)";
